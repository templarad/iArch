		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAltMethodAccess().getGroup_1(), "rule__AltMethod__Group_1__0");
					put(grammarAccess.getAltMethodAccess().getGroup_1_3(), "rule__AltMethod__Group_1_3__0");
					put(grammarAccess.getAltMethodAccess().getGroup_1_3_1(), "rule__AltMethod__Group_1_3_1__0");
					put(grammarAccess.getAltMethodAccess().getGroup_5(), "rule__AltMethod__Group_5__0");
					put(grammarAccess.getAltMethodAccess().getGroup_5_1(), "rule__AltMethod__Group_5_1__0");
					...
					put(grammarAccess.getAltMethodAccess().getTypeAssignment_1_0(), "rule__AltMethod__TypeAssignment_1_0");
					put(grammarAccess.getAltMethodAccess().getNameAssignment_1_1(), "rule__AltMethod__NameAssignment_1_1");
					put(grammarAccess.getAltMethodAccess().getParamAssignment_1_3_0(), "rule__AltMethod__ParamAssignment_1_3_0");
					put(grammarAccess.getAltMethodAccess().getParamAssignment_1_3_1_1(), "rule__AltMethod__ParamAssignment_1_3_1_1");
					put(grammarAccess.getAltMethodAccess().getTypeAssignment_2(), "rule__AltMethod__TypeAssignment_2");
					put(grammarAccess.getAltMethodAccess().getNameAssignment_3(), "rule__AltMethod__NameAssignment_3");
					put(grammarAccess.getAltMethodAccess().getParamAssignment_5_0(), "rule__AltMethod__ParamAssignment_5_0");
					put(grammarAccess.getAltMethodAccess().getParamAssignment_5_1_1(), "rule__AltMethod__ParamAssignment_5_1_1");
