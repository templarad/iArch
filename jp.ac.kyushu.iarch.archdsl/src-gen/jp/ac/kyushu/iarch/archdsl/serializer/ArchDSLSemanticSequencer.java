...
public class ArchDSLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ArchDSLPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ArchDSLPackage.UNCERTAIN_CONNECTOR:
				if(context == grammarAccess.getUncertainConnectorRule()) {
					sequence_UncertainConnector(context, (UncertainConnector) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (interfaces+=Interface | u_interfaces+=UncertainInterface | behaviors+=Behavior | u_connectors+=UncertainConnector | connectors+=Connector)*
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID (call+=SuperCall call+=SuperCall* end=[Interface|ID])?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID superInterface=[Interface|ID]? u_behaviors+=UncertainBehavior*)
	 */
	protected void sequence_UncertainConnector(EObject context, UncertainConnector semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
