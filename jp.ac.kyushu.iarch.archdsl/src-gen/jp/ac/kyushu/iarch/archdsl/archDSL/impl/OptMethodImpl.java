...
public class OptMethodImpl extends MinimalEObjectImpl.Container implements OptMethod
{
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchDSLPackage.OPT_METHOD__NAME, oldName, name));
  }
  ...
  public EList<Param> getParam()
  {
    if (param == null)
    {
      param = new EObjectContainmentEList<Param>(Param.class, this, ArchDSLPackage.OPT_METHOD__PARAM);
    }
    return param;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArchDSLPackage.OPT_METHOD__PARAM:
