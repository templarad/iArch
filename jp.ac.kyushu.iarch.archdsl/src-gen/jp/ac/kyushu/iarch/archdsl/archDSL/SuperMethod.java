 ...
 * <ul>
 *   <li>{@link jp.ac.kyushu.iarch.archdsl.archDSL.SuperMethod#getType <em>Type</em>}</li>
...
public interface SuperMethod extends EObject
{
   ...
   * @see #setType(String)
   * @see jp.ac.kyushu.iarch.archdsl.archDSL.ArchDSLPackage#getSuperMethod_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link jp.ac.kyushu.iarch.archdsl.archDSL.SuperMethod#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
