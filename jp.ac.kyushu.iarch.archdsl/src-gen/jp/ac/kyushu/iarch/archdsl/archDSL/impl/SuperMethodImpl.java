...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Super Method</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SuperMethodImpl extends MinimalEObjectImpl.Container implements SuperMethod
{
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchDSLPackage.SUPER_METHOD__NAME, oldName, name));
  }
  ...
  public EList<Param> getParam()
  {
    if (param == null)
    {
      param = new EObjectContainmentEList<Param>(Param.class, this, ArchDSLPackage.SUPER_METHOD__PARAM);
    }
    return param;
  }
