 ...
 * <ul>
 *   <li>{@link behavior.impl.BehavioralFeatureImpl#getMethod <em>Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BehavioralFeatureImpl extends FeatureImpl implements BehavioralFeature {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.BEHAVIORAL_FEATURE;
	}
	...
	public EList<Behavior> getMethod() {
		if (method == null) {
			method = new EObjectWithInverseResolvingEList<Behavior>(Behavior.class, this, BehaviorPackage.BEHAVIORAL_FEATURE__METHOD, BehaviorPackage.BEHAVIOR__SPECIFICATION);
		}
		return method;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.BEHAVIORAL_FEATURE__METHOD:
