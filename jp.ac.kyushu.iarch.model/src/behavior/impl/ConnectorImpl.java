 ...
 * <ul>
 *   <li>{@link behavior.impl.ConnectorImpl#getContract <em>Contract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends FeatureImpl implements Connector {
	...
	public EList<Behavior> getContract() {
		if (contract == null) {
			contract = new EObjectResolvingEList<Behavior>(Behavior.class, this, BehaviorPackage.CONNECTOR__CONTRACT);
		}
		return contract;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorPackage.CONNECTOR__CONTRACT:
				return getContract();
		}
