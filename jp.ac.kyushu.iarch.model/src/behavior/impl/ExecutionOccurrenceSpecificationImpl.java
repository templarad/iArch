 ...
 * <ul>
 *   <li>{@link behavior.impl.ExecutionOccurrenceSpecificationImpl#getExecution <em>Execution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionOccurrenceSpecificationImpl extends OccurrenceSpecificationImpl implements ExecutionOccurrenceSpecification {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.EXECUTION_OCCURRENCE_SPECIFICATION;
	}
		...
		if (execution != null && execution.eIsProxy()) {
			...
			if (execution != oldExecution) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
			}
		}
		return execution;
	}
	...
	public void setExecution(ExecutionSpecification newExecution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION:
