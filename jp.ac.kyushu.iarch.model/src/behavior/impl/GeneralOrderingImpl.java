 ...
 * <ul>
 *   <li>{@link behavior.impl.GeneralOrderingImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link behavior.impl.GeneralOrderingImpl#getAfter <em>After</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralOrderingImpl extends NamedElementImpl implements GeneralOrdering {
	...
	protected EClass eStaticClass() {
		return BehaviorPackage.Literals.GENERAL_ORDERING;
	}
		...
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.GENERAL_ORDERING__BEFORE, oldBefore, before));
			}
		}
		return before;
	}
	...
	public NotificationChain basicSetBefore(OccurrenceSpecification newBefore, NotificationChain msgs) {
		...
		before = newBefore;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviorPackage.GENERAL_ORDERING__BEFORE, oldBefore, newBefore);
	...
	public void setBefore(OccurrenceSpecification newBefore) {
		if (newBefore != before) {
			...
			if (before != null)
				msgs = ((InternalEObject)before).eInverseRemove(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_AFTER, OccurrenceSpecification.class, msgs);
			if (newBefore != null)
				msgs = ((InternalEObject)newBefore).eInverseAdd(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_AFTER, OccurrenceSpecification.class, msgs);
			msgs = basicSetBefore(newBefore, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.GENERAL_ORDERING__BEFORE, newBefore, newBefore));
	}
	...
	public OccurrenceSpecification getAfter() {
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.GENERAL_ORDERING__AFTER, oldAfter, after));
			}
		}
		return after;
	}
	...
	public NotificationChain basicSetAfter(OccurrenceSpecification newAfter, NotificationChain msgs) {
		...
		after = newAfter;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviorPackage.GENERAL_ORDERING__AFTER, oldAfter, newAfter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAfter(OccurrenceSpecification newAfter) {
		if (newAfter != after) {
			NotificationChain msgs = null;
			if (after != null)
				msgs = ((InternalEObject)after).eInverseRemove(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_BEFORE, OccurrenceSpecification.class, msgs);
			if (newAfter != null)
				msgs = ((InternalEObject)newAfter).eInverseAdd(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_BEFORE, OccurrenceSpecification.class, msgs);
			msgs = basicSetAfter(newAfter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.GENERAL_ORDERING__AFTER, newAfter, newAfter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.GENERAL_ORDERING__BEFORE:
				if (before != null)
					msgs = ((InternalEObject)before).eInverseRemove(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_AFTER, OccurrenceSpecification.class, msgs);
				return basicSetBefore((OccurrenceSpecification)otherEnd, msgs);
			case BehaviorPackage.GENERAL_ORDERING__AFTER:
				if (after != null)
					msgs = ((InternalEObject)after).eInverseRemove(this, BehaviorPackage.OCCURRENCE_SPECIFICATION__TO_BEFORE, OccurrenceSpecification.class, msgs);
