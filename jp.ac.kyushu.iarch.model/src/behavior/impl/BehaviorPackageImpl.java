...
public class BehaviorPackageImpl extends EPackageImpl implements BehaviorPackage {
	 ...
	 * @generated
	 */
	private EClass creatEventEClass = null;
	 ...
	 * @generated
	 */
	public EReference getBehavioredClassifier_Include() {
	 ...
	 * @generated
	 */
	public EReference getRedefinableElement_RedefinableELement() {
	 ...
	 * @generated
	 */
	public EAttribute getMessage_MessageOrder() {
	 ...
	 * @generated
	 */
	public EReference getLifeline_Endby() {
	 ...
	 * @generated
	 */
	public EReference getLifeline_Actor() {
	 ...
	 * @generated
	 */
	public EReference getLifeline_BehaviorExecution() {
	 ...
	 * @generated
	 */
	public EReference getInteraction_Object() {
	 ...
	 * @generated
	 */
	public EReference getInteraction_Destructionevent() {
	 ...
	 * @generated
	 */
	public EClass getCreatEvent() {
		return creatEventEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDestructionEvent_End() {
		return (EReference)destructionEventEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getDestructionEvent_Interaction() {
		return (EReference)destructionEventEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(behavioredClassifierEClass, BEHAVIORED_CLASSIFIER__INCLUDE);
		...
		createEReference(redefinableElementEClass, REDEFINABLE_ELEMENT__REDEFINABLE_ELEMENT);
		...
		createEAttribute(messageEClass, MESSAGE__MESSAGE_ORDER);
		...
		createEReference(lifelineEClass, LIFELINE__ENDBY);
		createEReference(lifelineEClass, LIFELINE__ACTOR);
		createEReference(lifelineEClass, LIFELINE__BEHAVIOR_EXECUTION);

		interactionEClass = createEClass(INTERACTION);
		createEReference(interactionEClass, INTERACTION__FRAGMENT);
		createEReference(interactionEClass, INTERACTION__OBJECT);
		createEReference(interactionEClass, INTERACTION__DESTRUCTIONEVENT);
		...
		creatEventEClass = createEClass(CREAT_EVENT);

		destructionEventEClass = createEClass(DESTRUCTION_EVENT);
		createEReference(destructionEventEClass, DESTRUCTION_EVENT__END);
		createEReference(destructionEventEClass, DESTRUCTION_EVENT__INTERACTION);
	...
	public void initializePackageContents() {
		...
		objectEClass.getESuperTypes().add(this.getBehavioredClassifier());
		...
		initEAttribute(getNamedElement_Archpoint(), ecorePackage.getEBoolean(), "Archpoint", null, 0, 1, NamedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBehavioredClassifier_Include(), this.getLifeline(), this.getLifeline_Actor(), "include", null, 1, 1, BehavioredClassifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(classEClass, behavior.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_NestedClassifier(), this.getClassifier(), null, "nestedClassifier", null, 0, -1, behavior.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRedefinableElement_RedefinableELement(), this.getRedefinableElement(), null, "redefinableELement", null, 0, -1, RedefinableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getElement_Owner(), this.getElement(), null, "owner", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getElement_OwnedElement(), this.getElement(), null, "ownedElement", null, 0, -1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMessage_MessageOrder(), ecorePackage.getEInt(), "MessageOrder", null, 0, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLifeline_Endby(), this.getDestructionEvent(), this.getDestructionEvent_End(), "endby", null, 1, 1, Lifeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLifeline_Actor(), this.getBehavioredClassifier(), this.getBehavioredClassifier_Include(), "actor", null, 1, 1, Lifeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLifeline_BehaviorExecution(), this.getBehaviorExecutionSpecification(), null, "behaviorExecution", null, 0, -1, Lifeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInteraction_Object(), this.getBehavioredClassifier(), null, "object", null, 0, -1, Interaction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInteraction_Destructionevent(), this.getDestructionEvent(), this.getDestructionEvent_Interaction(), "destructionevent", null, 0, -1, Interaction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(creatEventEClass, CreatEvent.class, "CreatEvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getDestructionEvent_End(), this.getLifeline(), this.getLifeline_Endby(), "end", null, 1, 1, DestructionEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDestructionEvent_Interaction(), this.getInteraction(), this.getInteraction_Destructionevent(), "interaction", null, 0, 1, DestructionEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(objectEClass, behavior.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
