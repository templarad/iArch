 ...
 * <!-- end-user-doc -->
 * @see umlClass.UmlClassPackage
 * @generated
 */
public class UmlClassSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static UmlClassPackage modelPackage;
	 ...
	 * @generated
	 */
	public UmlClassSwitch() {
		if (modelPackage == null) {
			modelPackage = UmlClassPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UmlClassPackage.NAMED_ELEMENT: {
			...
			case UmlClassPackage.CLASSIFIER: {
			...
			case UmlClassPackage.STRUCTURAL_FEATURE: {
			...
			case UmlClassPackage.CLASS: {
				umlClass.Class class_ = (umlClass.Class)theEObject;
			...
			case UmlClassPackage.ASSOCIATION: {
			...
			case UmlClassPackage.OPERATION: {
			...
			case UmlClassPackage.DATA_TYPE: {
			...
			case UmlClassPackage.TYPED_ELEMENT: {
			...
			case UmlClassPackage.PACKAGE: {
				umlClass.Package package_ = (umlClass.Package)theEObject;
			...
			case UmlClassPackage.GENERALIZATION: {
			...
			case UmlClassPackage.RELATIONSHIP: {
			...
			case UmlClassPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlClassPackage.DIRECTED_RELATIONSHIP: {
	 ...
	 * @generated
	 */
	public T caseClass(umlClass.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(umlClass.Package object) {
		return null;
	}
