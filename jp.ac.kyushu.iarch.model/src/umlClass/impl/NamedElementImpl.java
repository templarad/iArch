 ...
 * <ul>
 *   <li>{@link umlClass.impl.NamedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link umlClass.impl.NamedElementImpl#isArchpoint <em>Archpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedElementImpl extends ElementImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return UmlClassPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlClassPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public void setArchpoint(boolean newArchpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlClassPackage.NAMED_ELEMENT__ARCHPOINT, oldArchpoint, archpoint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UmlClassPackage.NAMED_ELEMENT__NAME:
				return getName();
			case UmlClassPackage.NAMED_ELEMENT__ARCHPOINT:
				return isArchpoint();
		}
