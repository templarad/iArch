...
public class DataflowDiagramSection extends GFPropertySection implements
    ...
    private ModifyListener listenerClassName = new ModifyListener() {
    	...
    	public void modifyText(ModifyEvent e) {
    		...
    		if (pe != null) {
    			...
    			if (bo == null)
    				return;
    			String name = ((NameSpace) bo).getName();
    ...
    public void refresh() {
        ...
        if (pe != null) {
            ...
            if (bo == null)
                return;
            String name = ((NameSpace) bo).getName();
            boolean isarchpint= ((NameSpace) bo).isArchpoint();
